		...
		<div class="content" id="content">
			...
			<ul class="pagination" >
				<c:if test="${pageMaker.prev}">
		        	<li><a href="etcList${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
		        </c:if>
				...
				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
		        	<li><a href="etcList${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
			    </c:if>
			</ul>
	...
	<layout:put block="scripts" type="REPLACE">
		<script type="text/javascript">
			...
			$('#searchBtn').on("click", function(event) {
			    var url = "etcList" + '${pageMaker.makeQuery(1)}'+ "&searchType="+ $("select option:selected").val() +
